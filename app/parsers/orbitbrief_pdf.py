...
# Table-cell repair now lives in the decode layer, where it belongs: it
# decides what a cell SAYS, never what it means. Re-exported so the call
# sites in this module -- and decode/pdf.py, which no longer has to import
# back into a 10k-line module for three pure functions -- are unchanged.
from app.parsers.decode._tables import (  # noqa: E402
